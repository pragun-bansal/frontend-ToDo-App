      ...
      />
            <div class="flex flex-col items-center justify-center">
                ...
                <div class="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                    ...
                    <button onClick={github} aria-label="Continue with github" role="button" class="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
                    ...
                    <div class="w-full flex items-center justify-between py-5">
                        ...
                        <div className={register?"mt-6":""}>
                            ...
                            onChange={handleChange}
                            value={register?regCred.email:loginCred.email}
                            type="email" 
                            // autoComplete='false'
                            id="email" 
                            class="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2"/>
                        ...
                        <div class="mt-6  w-full">
                           ...
                           <div class="relative flex items-center justify-center">
                            <input 
                            value={register?regCred.password:loginCred.password}
                            onChange={handleChange}
                            id="password" 
                            // autoComplete='false'
                            type={viewPassword?"text":"password" }
                            class="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2"/>
                            <div onClick={()=>setViewPassword(!viewPassword)} class="absolute right-0 mt-2 mr-3 cursor-pointer">
